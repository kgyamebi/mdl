...
Frontend runs at `http://localhost:5173` — sign in at `/login` for dashboard, inventory, and approvals (Phase 27).
...
| 32+ | Pending | Optional polish — see `docs/architecture/frontend-ui.md` |
